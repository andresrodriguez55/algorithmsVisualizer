export default function AdvancedSortAlgorithmsSketch(p)
{
    ...
    async function quickSort(starterIndex, size)
    {
        ...
        for(let x=1+starterIndex; x<size; x++)
        {
            if(!play)
                return;
        ...
        await mergeSort(starterIndex, position-1);
        await mergeSort(starterIndex+position, size-position);
    }
